 ...
 *---------------------------------------------------------------------------*/
 ...
 MIB_ENTRY snmp_mib[] = {
  ...
  /* ---------- Experimental MIB ----------- */
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_LOAD, DISPLAY_LOAD_FREQUENCY, 0},  				MIB_INT(snmp_load_frequency),  		NULL},	//мощность нагрузки
/*
...
*/
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_NUMBER, 33},  			MIB_INT(snmp_inv_number[32]),  	NULL},	//Номер инвертора
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_OUTPUT_VOLTAGE, 33},  			MIB_INT(snmp_inv_output_voltage[32]),  	NULL},	//Напряжение БПС2
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_OUTPUT_CURRENT, 33},  			MIB_INT(snmp_inv_output_current[32]),  	NULL},	//Ток БПС2
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_OUTPUT_POWER, 33},  			MIB_INT(snmp_inv_output_power[32]),  NULL},		//Состояние БПС2
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_TEMPERATURE, 33},  		MIB_INT(snmp_inv_temperature[32]),  NULL},	//Ток БПС1
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_STATUS, 33},  			MIB_INT(snmp_inv_stat[32]),  		NULL},
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_INPUT_VOLTAGE_DC, 33},  			MIB_INT(snmp_inv_input_voltage_DC[32]),  		NULL},		//Состояние БПС2
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_INPUT_VOLTAGE_AC, 33},  			MIB_INT(snmp_inv_input_voltage_AC[32]),  		NULL},		//Состояние БПС2
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_OUTPUT_BUS_VOLTAGE, 32},  			MIB_INT(snmp_inv_output_bus_voltage[31]),  		NULL},		//Состояние БПС2
 	{ MIB_INTEGER | MIB_ATR_RO,  	13, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_INV, DISPLAY_INV_ENTRY_OUTPUT_BUS_VOLTAGE, 33},  			MIB_INT(snmp_inv_output_bus_voltage[32]),  		NULL},		//Состояние БПС2
  ...
  */
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD, 0},  			MIB_INT(load_U),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD, 0},  			MIB_INT(load_I),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD, 0},  			MIB_INT(load_P),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD_PHASE_A, 0},  	MIB_INT(load_U_inv_3F[0]),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD_PHASE_A, 0},  	MIB_INT(load_I_inv_3F[0]),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD_PHASE_A, 0}, 		MIB_INT(load_P_inv_3F[0]),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD_PHASE_B, 0},  	MIB_INT(load_U_inv_3F[1]),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD_PHASE_B, 0},  	MIB_INT(load_I_inv_3F[1]),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD_PHASE_B, 0},  	MIB_INT(load_P_inv_3F[1]),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD_PHASE_C, 0},  	MIB_INT(load_U_inv_3F[2]),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD_PHASE_C, 0},  	MIB_INT(load_I_inv_3F[2]),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD_PHASE_C, 0},  	MIB_INT(load_P_inv_3F[2]),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD_PHASE_A_2PH, 0},  MIB_INT(load_U_inv_3F[0]),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD_PHASE_A_2PH, 0},  MIB_INT(load_I_inv_3F[0]),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD_PHASE_A_2PH, 0}, 	MIB_INT(load_P_inv_3F[0]),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD_PHASE_B_2PH, 0},  MIB_INT(load_U_inv_3F[1]),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD_PHASE_B_2PH, 0},  MIB_INT(load_I_inv_3F[1]),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD_PHASE_B_2PH, 0},  MIB_INT(load_P_inv_3F[1]),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_U_LOAD_BPINTEGR, 0},  	MIB_INT(snmpBPIntegrU),  NULL},				//Состояние БПС1
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_I_LOAD_BPINTEGR, 0},  	MIB_INT(snmpBPIntegrI),  NULL},				//Состояние БПС2
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_SYSTEM_WO_BYPASS, DISPLAY_P_LOAD_BPINTEGR, 0},  	MIB_INT(snmpBPIntegrP),  NULL},				//Состояние БПС3
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BYPASS, DISPLAY_BYPASS_FLAGS, 0},  				MIB_INT(snmpBypassFlagsA),  NULL},				//Состояние БПС3
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BYPASS, DISPLAY_BYPASS_FLAGS_A, 0},  				MIB_INT(snmpBypassFlagsA),  NULL},				//Состояние БПС3
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BYPASS, DISPLAY_BYPASS_FLAGS_B, 0},  				MIB_INT(snmpBypassFlagsB),  NULL},				//Состояние БПС3
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BYPASS, DISPLAY_BYPASS_FLAGS_C, 0},  				MIB_INT(snmpBypassFlagsC),  NULL},				//Состояние БПС3
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BYPASS, DISPLAY_BYPASS_F_LOAD, 0},  				MIB_INT(snmp_load_frequency),  NULL},		//Состояние БПС3
