...
Kudcin=lc640_read_int(EE_KUDCIN);
...
if((NUMBYPASS<0)||(NUMBYPASS>10))NUMBYPASS=0;
NUMPHASE=lc640_read_int(EE_NUMPHASE);
//NUMOUTPHASE=lc640_read_int(EE_NUMOUTPHASE);
NUMINAC=lc640_read_int(EE_NUMINAC);
...
WORK_FROM_MAIN=lc640_read_int(EE_WORK_FROM_MAIN);
SET_BLOCK=lc640_read_int(EE_SET_BLOCK);
...
U_OUT_AC_MAX_AV=lc640_read_int(EE_U_OUT_AC_MAX_AV);
U_OUT_AC_MIN_AV=lc640_read_int(EE_U_OUT_AC_MIN_AV);
U_IN_AC_MAX_AV=lc640_read_int(EE_U_IN_AC_MAX_AV);
...
CAN_FILTR_EN=lc640_read_int(EE_CAN_FILTR_EN);
...
//NUMBYPASS=-1;
//NUMPHASE=-1;
if((NUMBYPASS>10)||(NUMBYPASS<0)) NUMBYPASS=10;
