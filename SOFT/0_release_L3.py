...
source_file1 = ".\\EXE\\UKU2071x_INV_WG12232L3.hex"
...
targetDir_=targetDir+build_year+"_"+build_month+"_"+build_day+"__"+version+"."+subversion+"."+build+ "_L3"
print(targetDir_)
...
target_file=targetDir_+ "\\inv_sys_"+"_"+build_year+"_"+build_month+"_"+build_day+"__"+version+"."+subversion+"."+build+ "_L3"+".hex"
...
if messageStr != '':
    ...
    my_file.write("\n \n \n" +build_year+"/"+build_month+"/"+build_day+"   "+version+"."+subversion+"."+build+ "_L3")
    my_file.write("\n \n" + messageStr)
    my_file.close()
