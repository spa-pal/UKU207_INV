...
i=inv[0]._flags_tm&0xf7;
ii=0;
if(inv[0]._conn_av_stat) 	ii|=1;
else 						ii&=~1;	 
if(inv[0]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[32]=ii;								//Рег17
modbus_registers[33]=i;
modbus_registers[34]=(char)(inv[0]._Udcin/256);		//Рег18
modbus_registers[35]=(char)(inv[0]._Udcin%256);
...
i=inv[1]._flags_tm&0xf7;
ii=0;
if(inv[1]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[1]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[52]=ii;								//Рег27
modbus_registers[53]=i;
modbus_registers[54]=(char)(inv[1]._Udcin/256);		//Рег28
modbus_registers[55]=(char)(inv[1]._Udcin%256);
...
i=inv[2]._flags_tm&0xf7;
ii=0;
if(inv[2]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[2]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[72]=ii;								//Рег37
modbus_registers[73]=i;
modbus_registers[74]=(char)(inv[2]._Udcin/256);		//Рег38
modbus_registers[75]=(char)(inv[2]._Udcin%256);
...
i=inv[3]._flags_tm&0xf7;
ii=0;
if(inv[3]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[3]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[92]=ii;								//Рег47
modbus_registers[93]=i;
modbus_registers[94]=(char)(inv[3]._Udcin/256);		//Рег48
modbus_registers[95]=(char)(inv[3]._Udcin%256);
...
i=inv[4]._flags_tm&0xf7;
ii=0;
if(inv[4]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[4]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[112]=ii;								//Рег57
modbus_registers[113]=i;
modbus_registers[114]=(char)(inv[4]._Udcin/256);		//Рег58
modbus_registers[115]=(char)(inv[4]._Udcin%256);
...
i=inv[5]._flags_tm&0xf7;
ii=0;
if(inv[5]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[5]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[132]=ii;								//Рег67
modbus_registers[133]=i;
modbus_registers[134]=(char)(inv[5]._Udcin/256);		//Рег68
modbus_registers[135]=(char)(inv[5]._Udcin%256);
...
i=inv[6]._flags_tm&0xf7;
ii=0;
if(inv[6]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[6]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[152]=ii;								//Рег77
modbus_registers[153]=i;
modbus_registers[154]=(char)(inv[6]._Udcin/256);		//Рег78
modbus_registers[155]=(char)(inv[6]._Udcin%256);
...
i=inv[7]._flags_tm&0xf7;
ii=0;
if(inv[7]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[7]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[172]=ii;								//Рег87
modbus_registers[173]=i;
modbus_registers[174]=(char)(inv[7]._Udcin/256);		//Рег88
modbus_registers[175]=(char)(inv[7]._Udcin%256);
...
i=inv[8]._flags_tm&0xf7;
ii=0;
if(inv[8]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[8]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[192]=ii;								//Рег97
modbus_registers[193]=i;
modbus_registers[194]=(char)(inv[8]._Udcin/256);		//Рег98
modbus_registers[195]=(char)(inv[8]._Udcin%256);
...
i=inv[9]._flags_tm&0xf7;
ii=0;
if(inv[9]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[9]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[212]=ii;								//Рег107
modbus_registers[213]=i;
modbus_registers[214]=(char)(inv[9]._Udcin/256);		//Рег108
modbus_registers[215]=(char)(inv[9]._Udcin%256);
...
i=inv[10]._flags_tm&0xf7;
ii=0;
if(inv[10]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[10]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[232]=ii;								//Рег117
modbus_registers[233]=i;
modbus_registers[234]=(char)(inv[10]._Udcin/256);		//Рег118
modbus_registers[235]=(char)(inv[10]._Udcin%256);
...
i=inv[11]._flags_tm&0xf7;
ii=0;
if(inv[11]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[11]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[252]=ii;								//Рег127
modbus_registers[253]=i;
modbus_registers[254]=(char)(inv[11]._Udcin/256);		//Рег128
modbus_registers[255]=(char)(inv[11]._Udcin%256);
...
i=inv[12]._flags_tm&0xf7;
ii=0;
if(inv[12]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[12]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[272]=ii;								//Рег137
modbus_registers[273]=i;
modbus_registers[274]=(char)(inv[12]._Udcin/256);		//Рег138
modbus_registers[275]=(char)(inv[12]._Udcin%256);
...
i=inv[13]._flags_tm&0xf7;
ii=0;
if(inv[13]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[13]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[292]=ii;								//Рег147
modbus_registers[293]=i;
modbus_registers[294]=(char)(inv[13]._Udcin/256);		//Рег148
modbus_registers[295]=(char)(inv[13]._Udcin%256);
...
i=inv[14]._flags_tm&0xf7;
ii=0;
if(inv[14]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[14]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[312]=ii;								//Рег157
modbus_registers[313]=i;
modbus_registers[314]=(char)(inv[14]._Udcin/256);		//Рег158
modbus_registers[315]=(char)(inv[14]._Udcin%256);
...
i=inv[15]._flags_tm&0xf7;
ii=0;
if(inv[15]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[15]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[332]=ii;									//Рег167
modbus_registers[333]=i;
modbus_registers[334]=(char)(inv[15]._Udcin/256);			//Рег168
modbus_registers[335]=(char)(inv[15]._Udcin%256);
...
i=inv[16]._flags_tm&0xf7;
ii=0;
if(inv[16]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[16]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[352]=ii;									//Рег177
modbus_registers[353]=i;
modbus_registers[354]=(char)(inv[16]._Udcin/256);			//Рег178
modbus_registers[355]=(char)(inv[16]._Udcin%256);
...
i=inv[17]._flags_tm&0xf7;
ii=0;
if(inv[17]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[17]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[372]=ii;									//Рег187
modbus_registers[373]=i;
modbus_registers[374]=(char)(inv[17]._Udcin/256);			//Рег188
modbus_registers[375]=(char)(inv[17]._Udcin%256);
...
i=inv[18]._flags_tm&0xf7;
ii=0;
if(inv[18]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[18]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[392]=ii;									//Рег207
modbus_registers[393]=i;
modbus_registers[394]=(char)(inv[18]._Udcin/256);			//Рег208
modbus_registers[395]=(char)(inv[18]._Udcin%256);
...
i=inv[19]._flags_tm&0xf7;
ii=0;
if(inv[19]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[19]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[412]=ii;									//Рег217
modbus_registers[413]=i;
modbus_registers[414]=(char)(inv[19]._Udcin/256);			//Рег218
modbus_registers[415]=(char)(inv[19]._Udcin%256);
...
i=inv[20]._flags_tm&0xf7;
ii=0;
if(inv[20]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[20]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[432]=ii;									//Рег227
modbus_registers[433]=i;
modbus_registers[434]=(char)(inv[20]._Udcin/256);			//Рег228
modbus_registers[435]=(char)(inv[20]._Udcin%256);
...
i=inv[21]._flags_tm&0xf7;
ii=0;
if(inv[21]._conn_av_stat) 	ii|=1;
else 						ii&=~1;
if(inv[21]._flags_tm_dop&0x0001)	ii|=(1<<1);
else 							ii&=~(1<<1);
modbus_registers[452]=ii;									//Рег237
modbus_registers[453]=i;
modbus_registers[454]=(char)(inv[21]._Udcin/256);			//Рег238
modbus_registers[455]=(char)(inv[21]._Udcin%256);
