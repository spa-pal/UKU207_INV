...
/*	int2lcdyx(makb[2]._cnt,0,10,0);*/
	...
	//int2lcdyx(snmp_numofevents,0,19,0);
	}
	...
	if(but==butD)
		...
		if(sub_ind==0)
			...
			if(avar_ind_stat)
		    	...
		    	{
		    	tree_up(iInv_v2,0,0,sub_ind-NUMBYPASS-1);
		    	}
...
#define SIMAXIDEF 8
	...
	if(but==butD)
		...
		if(sub_ind==0)
			...
			{
			def_set(2450,2410,2315,187,30,2200,2,2410);
