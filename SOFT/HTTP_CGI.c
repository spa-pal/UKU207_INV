...
U16 cgi_func (U8 *env, U8 *buf, U16 buflen, U32 *pcgi) {
  ...
  switch (env[0]) {
    ...
    case 'b':
		...
		switch (env[1]) {
			case '1':
				len = sprintf((char *)buf,(const char *)&env[3],http_tm_bypass_output(0));
		  		break;
			case '2':
				len = sprintf((char *)buf,(const char *)&env[3],http_tm_bypass_output(1));
		  		break;
			case '3':
				len = sprintf((char *)buf,(const char *)&env[3],http_tm_bypass_output(2));
		  		break;
    ...
    case 'j':
		...
		switch (env[1]) {
			case '1':
				len = sprintf((char *)buf,(const char *)&env[3],http_tm_load_output(0));
		  		break;
			case '2':
				len = sprintf((char *)buf,(const char *)&env[3],http_tm_load_output(1));
		  		break;
			case '3':
				len = sprintf((char *)buf,(const char *)&env[3],http_tm_load_output(2));
		  		break;
	...
	case 'd':
		...
		switch (env[1]) {
			case '0':
				...
				switch (env[2]) {
					case '1':
						len = sprintf((char *)buf,(const char *)&env[4],pal_cyr_coder("Здесь будет название конфигурации"));
						//if(AUSW_MAIN==24120)
							{
					...
					break;
			        case '5':	//количество выходных фаз
						len = sprintf((char *)buf,(const char *)&env[4],NUMPHASE);
					break;
    ...
    case 'f':
      ...
      switch (env[1]) {
        case '1':
          len = sprintf((char *)buf,(const char *)&env[3],http_tm_status_output());
          break;
        case '2':
    ...
    case 'o':
     ...
     case 'i':
		/* телеметрия инверторов */
      	switch (env[1]) {
        	case '0':
          		switch (env[2]) {
		        	case '0':
		          		//len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(0));
						len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(0));
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(1));
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(2));
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(3));
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(4));
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(5));
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(6));
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(7));
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(8));
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(9));
		          		break;	
				}
				break;
        	case '1':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(10));
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(11));
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(12));
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(13));
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(14));
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(15));
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(16));
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(17));
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(18));
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(19));
		          		break;	 
				}
				break;
        	case '2':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(20));
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(21));
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(22));
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(23));
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(24));
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(25));
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(26));
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(27));
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(28));
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(29));
		          		break;	 
				}
				break;
        	case '3':
          		switch (env[2]) {
		        	case '0':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(30));
		          		break;
		     		case '1':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(31));
		          		break;
		     		case '2':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(32));
		          		break;
		     		case '3':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(33));
		          		break;
		     		case '4':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(34));
		          		break;
		        	case '5':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(35));
		          		break;
		     		case '6':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(36));
		          		break;
		     		case '7':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(37));
		          		break;
		     		case '8':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(38));
		          		break;
		     		case '9':
		          		len = sprintf((char *)buf,(const char *)&env[4],http_tm_inv_output(39));
		          		break;	 
				}
				break;
		}
